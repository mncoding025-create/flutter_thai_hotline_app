      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Text('สายด่วน\nสาธารณูปโภค', textAlign: TextAlign.center, style: GoogleFonts.kanit(fontSize: 22, fontWeight: FontWeight.bold)),
            const SizedBox(height: 15),
            Image.asset(
              'assets/images/GEW.jpg',
              height: 120,
              errorBuilder: (context, error, stackTrace) => Container(height: 120, width: 200, color: Colors.grey[200], child: const Icon(Icons.image)),
            ),
            const SizedBox(height: 20),
            
            _buildPhoneCard('การไฟฟ้านครหลวง', '1130', 'mea.png'),
            _buildPhoneCard('การไฟฟ้าส่วนภูมิภาค', '1129', 'pea.jpg'),
            _buildPhoneCard('การประปานครหลวง', '1125', 'mwa.png'),
            _buildPhoneCard('การประปาส่วนภูมิภาค', '1662', 'pwa.jpg'),
